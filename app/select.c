...
/*
      ...
      if(++arg_i >= argc)
        ...
        stat = zsv_printerr(1, "-u value must be a single-byte UTF8 char or empty string");
      else
        data.opts->malformed_utf8_replace = *argv[arg_i] ? *argv[arg_i] : -1; // data.malformed_utf8_replace = (const unsigned char*)argv[arg_i];
*/
