...
static const struct zsv_help_command commands[] = {
  ...
  {"2toon", "convert CSV or sqlite3 db table to TOON (compact, token-oriented; see `help toon`)"},
  ...
  {"json2toon", "convert JSON to TOON"},
  {"toon2json", "convert TOON to JSON"},
  {"toon", "describe the TOON encoding grammar (also `help toon`)"},
  {"prop",
