...
int _context_menu_alloc_entry(
    struct context_menu *menu, const char *name, zsvsheet_proc_id_t proc_id,
    bool proc_ephemeral)
{
...
int context_menu_new_entry_func(
    struct context_menu *menu, const char *name, zsvsheet_proc_fn handler)
{
